...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  login() async {
    ...
    await authController.signUpUsers(context, email, fullName, password).whenComplete((){
          ...
          children: [
            Positioned(
              ...
              child:                   Image.asset(
                ...
                fit: BoxFit.cover, // Phải có thuộc tính này ms làm cho width và height đc apply, để bóp ảnh.
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Nhận ưu đãi đặc biệt - đăng ký ngay',
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  border: OutlineInputBorder(
                                    // Tạo viền cho input
                                      borderRadius: BorderRadius.circular(9) // Bo viền 9.
                                  ),
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                if(value!.isEmpty) return 'Mật khẩu đang trống';
                                else return null;
                              },
                              decoration: InputDecoration(
                                  fillColor: Colors.white,
                            ...
                            TextFormField(
                              onChanged: (value){
                                password.contains(value.toString());
                              },
                              validator: (value) {
                                if(value!.isEmpty) return 'Nhập lại mật khẩu đang trống!';
                                return null;
                              },
                              decoration: InputDecoration(
                                  fillColor: Colors.white,
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(9),
                                    border: Border.all(
                                      width: 2, color: Color(0xFF05999E),
                                    ),
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Positioned(
                                        right: 40 ,
                                        bottom: 25,
                                        child: Opacity(opacity: 0.4,child: Container(
                                          width: 20,
                                          height: 20,
                                          clipBehavior: Clip.antiAlias,
                                          decoration: BoxDecoration(
