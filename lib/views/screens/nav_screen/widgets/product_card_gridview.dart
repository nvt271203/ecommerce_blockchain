...
Widget customProductCardWidget(context, String imageUrl, String productName,
    String price, ProductModel product) {
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  convertedPrice.toString().length > 3
                      ? Text(
                    convertedPrice.toString().substring(0, 3) + " ETH",
                    style: TextStyle(
                        fontSize: 15, color: constants.mainBlackColor),
                  )
                      : Text(
                    convertedPrice.toString() + " ETH",
                    style: TextStyle(
                        fontSize: 15, color: constants.mainBlackColor),
                  )
                ],
